    ...
    <div className="h-screen w-screen overflow-hidden bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          {/* User Profile Card */}
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/50 shadow-xl">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-xl">
            ...
            <p className="text-sm text-gray-600 mb-4">Go to the image workspace to upload and view your image on canvas.</p>
            <button
              onClick={() => { window.location.hash = '#/image'; }}
              className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold transition-colors duration-200"
            >
              Go to Image Workspace
            </button>
          </div>
        </div>
      </div>
